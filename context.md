# kill de Auditoria e Refatoração Arquitetural
Imagine o seguinte cenário: você herdou 3 projetos legados com problemas de arquitetura, segurança e qualidade de código. Revisar e corrigir tudo manualmente levaria dias.
...
1. Analisar uma codebase detectando linguagem, framework e arquitetura atual
2. Identificar anti-patterns e code smells, classificando por severidade com arquivo e linha exatos
3. Gerar um relatório de auditoria estruturado com todos os achados
4. Refatorar o projeto para o padrão MVC (Model-View-Controller), eliminando os problemas encontrados
5. Validar o resultado garantindo que a aplicação continua funcionando após as mudanças
6. A skill deve ser agnóstica de tecnologia, funcionando com diferentes linguagens e frameworks.
